namespace TelerikAcademyLearningSystem.Core.Pages.StudentsStatisticsByAgePage
{
    ...
    public partial class StudentsStatisticsByAgePage
    {
        public string Title
        {
            get
        ...
        public HtmlSpan YearRange
        {
            get
            {
                return Manager.Current.ActiveBrowser.Find.ByXPath<HtmlSpan>("//*[@id='MainContent']/div/table/tbody/tr/td[3]/div/span/span/span[1]");
            }
        }
